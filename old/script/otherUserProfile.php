...
$numberOfVideoQry = "SELECT u.video_id FROM `upload_video` u INNER JOIN `alacut_member` a ON a.member_id = u.video_upload_by WHERE u.video_upload_by = '".$_REQUEST['id']."' AND u.status !='2' ";
