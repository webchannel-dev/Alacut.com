...
$LargeVideoId = 0;	
	...
	if(isset($_REQUEST['vid']) > 0){		
		$iframeVideoPostQry = "SELECT u.video_id,u.video_object,u.video_type,u.like,u.dislike,a.member_id,a.full_name, u.visit, l.status AS ldStatus, a.active
...
<section class="inner_left">
    <section class="left_body_box">
        ...
        <?php include("loginUserCommentByAdmin.php");?>
        </div>
    </section>
 ...
 <?php if($videoPostNum > 0)  { ?>
  ...
  ?>     
        <article class="thumb"><a href="userProfileViewByAdmin.php?id=<?php echo $_REQUEST['id'];?>&vid=<?php echo $videoPostInfo['video_id']?>"><img  class="video" src="<?php echo $thumbImgPath?>" width="140" height="74" data="<?php echo $mostLikeVideoInfo['video_object']?>" videoType = "<?php echo $videoPostInfo['video_type'] ?>" vidid = "<?php echo $videoPostInfo['video_id']?>"/></a>
