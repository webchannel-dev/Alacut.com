  ...
  <section class="admin_panel">
   ...
   <table>
    ...
    <header class="search">
      	<tr>
        <td>Name: 
      	  <input name="txtUsername" type="text" class="input1" id="txtUsername">
      	</td>
      	<td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
     ...
     <?php if($userDetailNum > 0){
      ...
      <tr>
        ...
        <td><a href="deActiveByAdmin.php?id=<?php echo $userDetailInfo['member_id']?>" id="button3" name="button3" class="but1">De-activate</a></td>
        <?php }else{?>
