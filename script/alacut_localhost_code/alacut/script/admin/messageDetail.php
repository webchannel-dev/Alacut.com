...
include('../../config/config1.php');
	...
	$messageDetailQry = "SELECT m.message_id, m.message_content, m.date_time, m.active,
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <tr>
       ...
       <td><?php echo date("d/m/Y", strtotime($messageDetailInfo['date_time']))?></td>
		<?php if($messageDetailInfo['active'] == '1'){?> 
        <td><a href="messageDisApproval.php?id=<?php echo $messageDetailInfo['message_id']?>" class="but2">Dis-approve</a></td>
		<?php }else{?>
            <td><a href="messageApproval.php?id=<?php echo $messageDetailInfo['message_id']?>" class="but2">Approve</a></td>
        <?php }?>

       <td><a href="deleteMessageByAdmin?id=<?php echo $messageDetailInfo['message_id']?>" class="but2">Delete</a></td>
      </tr>
      <?php } ?>
    </table>   
	</section>
