...
if (!$done)
	...
	if ($step=='get_contacts')
		...
		$contents.="<table align='center' class='thTable' cellspacing='2' cellpadding='0' style='border:none;'>
			<tr class='thTableRow'><td align='right'><label for='email_box'>Email&nbsp;Address</label></td><td><span class='fieldbox'>
<input class='thTextbox' type='text' name='email_box' value='{$_POST['email_box']}'</span></td></tr>
			<tr class='thTableRow'><td align='right'><label for='password_box'>Password</label></td><td><span class='fieldbox'><input class='thTextbox' type='password' name='password_box' value='{$_POST['password_box']}'></span></td></tr>
			
			<tr class='thTableRow'><td align='right'><label for='provider_box'>Email provider</label></td><td><span class='fieldbox'><select class='thSelect' name='provider_box' style='width: 263px;'><option value=''></option>";
		...
		$contents.="</select></span></td></tr>
		
			<tr class='thTableImportantRow'><td colspan='2' align='center'><input class='submitnew1' type='submit' name='import' value='Import Contacts'></td></tr>
		...
		$contents.="<table class='thTable' cellspacing='0' cellpadding='0' style='border:none;'>
				<tr class='thTableRow'><td align='right' valign='top'><label for='message_box'>Message</label></td><td><textarea rows='10' cols='50' name='message_box' class='thTextArea' style='width:400px;'>{$_POST['message_box']}</textarea></td></tr>
				<tr class='thTableRow'><td align='center' colspan='2'><input type='submit' name='send' value='Send Invites' class='submitnew1' ></td></tr>
			</table>";
	}
	...
	if ($step=='send_invites')
		...
		if ($inviter->showContacts())
			...
			if (count($contacts)==0)
				...
				{
				$contents.="<tr class='thTableDesc'><td><input type='checkbox' onChange='toggleAll(this)' name='toggle_all' title='Select/Deselect all' checked></td><td>Invite?&nbsp;&nbsp<b>Friends&nbsp;Name</b></td>".($plugType == 'email' ?"<td><b>Email Address</b></td>":"")."</tr>";
				$odd=true;$counter=0;
				...
				$contents.="<tr class='thTableFooter'><td colspan='".($plugType=='email'? "3":"2")."' style='padding:3px;'><input type='submit' name='send' value='Send invites' class='submitnew1'></td></tr>";
				}
			$contents.="</table>";
			}
