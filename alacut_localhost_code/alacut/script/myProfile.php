...
$LargeVideoId = 0;
	...
	if($iframeVideoPostNUM > 0)
	{
		...
		WHERE member_id='$member_ID' AND u.status!= '2'  AND u.video_id != '".$iframeVideoPostInfo['video_id']."' ORDER BY `like` DESC LIMIT 4";
...
<section class="inner_left">
    <section class="left_body_box">
        ...
        <section class="left_vid_cont">
          <div class="vid_name" id="vidTitle"><?php echo $title?></div>
    ...
    <nav class="button"><a href="inviteFriends.php">Find&nbsp;Friends</a></nav>
