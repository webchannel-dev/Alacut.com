...
$isYouTube = FALSE;
 $videoPostQry ="SELECT u.video_id,u.video_upload_by,u.video_object,u.video_type,u.video_image,u.video_desc,u.video_name,u.like,u.dislike,u.video_url,a.member_id, a.full_name, u.visit, l.status AS ldStatus
...
<!--<div id="largeVideo">-->
 <iframe id="div_youTube" width="640" height="360" src="<?php echo $videoSrc;?>" vidID = "<?php echo $videoPostInfo['video_id']?>" frameborder="0" allowfullscreen></iframe>
  <div class="left_vid_cont">
      ...
      <a href="<?php if($videoPostInfo['video_upload_by']==$memberid) echo "myProfile.php"; else echo "otherUserProfile.php?id=".$videoPostInfo['video_upload_by']?>"><div class="user_name"><?php echo $videoPostInfo['full_name']?></div></a>
      <div class="sn_img">
      	<a onclick="window.open('http://www.linkedin.com/shareArticle?mini=true&url=<?php echo 'http://www.alacut.com?vid='.$videoPostInfo['video_id'];?>&title=<?php echo $title;?>&summary=<?php echo $description;?>','linkedin','toolbar=0,status=0,width=600,height=400')" href="javascript: void(0)"><img src="images/in.jpg" width="30" height="30" alt="in" />
      		
      	</a>
      	<a onClick="window.open('http://www.facebook.com/sharer.php?s=100&amp;p[title]=<?php echo $title;?>&amp;p[summary]=<?php echo $summary;?>&amp;p[url]=<?php echo 'www.alacut.com?vid='.$videoPostInfo['video_id']; ?>&amp;&amp;p[images][0]=<?php echo $image;?>','facebook','toolbar=0,status=0,width=600,height=400');" target="_parent" href="javascript: void(0)"><img src="images/fb.jpg" width="30" height="30" />
      		
      	</a><a onclick="window.open('https://twitter.com/intent/tweet?source=webclient&text=<?php echo $title;?>&url=<?php echo 'http://www.alacut.com?vid='.$videoPostInfo['video_id'];?>','twitter','toolbar=0,status=0,width=600,height=400')" target="_parent" href="javascript: void(0)"><img src="images/twt.jpg" width="30" height="30" /></a><a href="javascript: void(0)"><img src="images/alacut.jpg" width="30" height="30" /></a></div>
      <div class="choice">
                <div class="top">	
