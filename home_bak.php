...
<section class="inner">
    ...
    <section id="homeFrame" class="left_body_box" <?php  if($numberOfVideoNum == 0){ echo "style='display:none;'"; }?>>
        ...
        <section class="left_vid_cont">
          ...
          <a style='text-decoration: none;' href="<?php if($iframeVideoPostInfo['video_upload_by']==$member_id) echo "myProfile.php"; else echo "otherUserProfile.php?id=".$iframeVideoPostInfo['video_upload_by']?>"><div class="user_name"><?php echo $iframeVideoPostInfo['full_name']?></div></a>
          <div class="sn_img">
