...
if($_REQUEST['id']==$member_id)
{
	header("Location: allPosts.php");exit();
}
$_SESSION['page']=0;
$myProfileSql = "SELECT `full_name`,`job`,`education`,`address`,`relationship`,`married_to`,`url`,`handle`,
	...
	$videoPostQry = "SELECT u.video_id,u.video_upload_by,u.video_object,u.video_name,u.video_desc,u.video_image,u.visit,u.video_type,u.like,u.dislike,a.full_name,u.uploaded_date, 
     ...
     WHERE u.video_upload_by ='".$_REQUEST['id']."' AND u.status != '2' ORDER BY u.uploaded_date DESC LIMIT 0,20";
...
function LoadVideo()
{
	...
	if(page*20<tot && $('.left_body > div.load').length==0 )
	{
		$('.left_body').append("<div class='load' style='padding-left: 210px;'><img src='ajax-loader.gif' alt='Loading...' /></div>");
	$.ajax({
			type: "POST",
...
<div class="inner_left">
	<div class="left_head1">
      ...
      <div class="left_body_box" style="display:none;box-shadow: 0 0 1px #333;">
      <div id="largeVideo" >
